...
<div id="mobile-menu" class="mobile-menu" aria-hidden="true">
    <nav class="mobile-navigation" role="navigation" aria-label="<?php esc_attr_e('Mobile Navigation', 'Bo'); ?>">
        <?php
