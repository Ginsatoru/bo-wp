 ...
 * UPDATED: Billing address only, no ship-to-different-address
 *
...
<div class="woocommerce-checkout-progress">
	<div class="checkout-steps">
		...
		<svg class="step-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
